                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-hover text-nowrap" id="client">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Photo</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{asset('storage/file-user/'.$d->image)}}" alt="" width="100">
                                        </td>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>Apa kamu yakin kids?<b>{{$d->name}}</b></p>
                                                </div>
                                                <div class="modal-footer justify-content-between">
                                                    <form action="{{route('admin.user.delete',['id'=>$d->id])}}"
                                                        ...
                                                        <button type="submit" class="btn btn-primary">Saya
                                                            yakin</button>
                                                    </form>
                                                </div>
                                            </div>
